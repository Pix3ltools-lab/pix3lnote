...
export function Sidebar() {
  ...
  return (
    <nav className="flex w-14 flex-col items-center gap-1 border-r border-gray-100 bg-white px-2 py-3 sm:w-52 sm:items-start sm:px-3">
      {/* Notes */}
      <NavItem
        icon={
          ...
          {labels.map(label => (
            <div key={label.id} className="group flex items-center">
              ...
              <button
                ...
                className="hidden sm:block mr-1 rounded-full p-1 text-gray-300 opacity-0 transition-opacity hover:text-gray-500 group-hover:opacity-100"
                title="Delete label"
              >
        ...
        {showNewLabel ? (
          <form onSubmit={handleCreateLabel} className="hidden sm:flex items-center gap-1 px-2">
            <input
              ...
              className="flex-1 rounded-lg border border-gray-300 px-2 py-1 text-xs outline-none focus:border-violet-400"
            />
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-gray-400 hover:bg-gray-50 hover:text-gray-600 w-full transition-colors"
          >
